...
const RESTAURANT_COORDS = { latitude: 17.0765705, longitude: 82.1340028 };
      ...
      <ScrollView style={styles.scrollArea} contentContainerStyle={{ paddingBottom: insets.bottom + 20 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.mapContainer}>
          <MapView
            ...
            markers={[
              { lat: RESTAURANT_COORDS.latitude, lng: RESTAURANT_COORDS.longitude, type: 'restaurant' },
              ...(userLocation ? [{ lat: userLocation.latitude, lng: userLocation.longitude, type: 'customer' }] : [])
            ]}
          />
