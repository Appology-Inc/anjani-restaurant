/**
 * @file CustomAlertProvider.tsx
 * @description A global provider that overrides the default `Alert.alert` behavior on the web.
 * It renders a beautifully animated, custom modal alert using `react-native` animations
 * and `expo-blur`. On native, it falls back to the default OS Alert or can be customized further.
 */
...
/** Global reference to the setAlertState function to allow imperative calls from overridden Alert.alert */
...
/**
 * Provider component that should wrap the application root.
 * It listens for global alert state changes and renders an animated modal over the children.
 * 
 * @param {Object} props - Component properties.
 * @param {React.ReactNode} props.children - The application component tree to render.
 */
