    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.moonContainer}>
          ...
          <Ionicons name="moon" size={80} color="#FDE047" />
        ...
        <Text style={styles.title}>It's late...</Text>
        <Text style={styles.subtitle}>We're closed for the night. See you tomorrow!</Text>
        ...
        <View style={styles.infoBox}>
          ...
          <View style={styles.infoTextContainer}>
            <Text style={styles.infoLabel}>WE'LL BE BACK AT</Text>
